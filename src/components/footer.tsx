...
const footerLinks = {
  ...
  'Opportunities': [
    ...
    { label: 'Fellowships', href: '/opportunities' },
    { label: 'Bursaries', href: '/opportunities' },
      ...
      <footer className="bg-gray-900 text-gray-300 pt-14 pb-8">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-10">
            {/* Column 1: Brand */}
            <div>
              <a href="/" className="inline-flex items-center gap-2 text-[1.3rem] font-extrabold text-white no-underline mb-3.5">
                <svg width="26" height="26" viewBox="0 0 32 32">
                  <rect width="32" height="32" rx="8" fill="#1a56db" />
                  <path d="M8 16l4 4 12-12" stroke="#fff" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                JobReady.co.ke
              </a>
              <p className="text-[0.87rem] leading-relaxed opacity-80 max-w-xs">
                Kenya&apos;s fastest-growing job board connecting top talent with leading employers.
                Browse jobs, internships, scholarships, and career resources — all in one place.
              </p>
            </div>
            ...
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h4 className="text-white text-[0.92rem] font-semibold mb-3.5">{title}</h4>
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <span>&copy; {new Date().getFullYear()} JobReady.co.ke. All rights reserved. Data Protection Act 2019 compliant.</span>
